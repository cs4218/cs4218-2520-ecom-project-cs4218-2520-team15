...
export const options = {
  ...
  thresholds: {
    "http_req_duration{endpoint:all-orders}": ["p(95)<2000"],
    "http_req_duration{endpoint:orders}": ["p(95)<400"],
    "http_req_duration{endpoint:order-status}": ["p(95)<600"],
    ...
    "http_req_duration{endpoint:product-detail}": ["p(95)<600"],
    "http_req_duration{endpoint:product-photo}": ["p(95)<800"],
    "http_req_duration{endpoint:categories}": ["p(95)<400"],
    "http_req_duration{endpoint:categories-paged}": ["p(95)<1000"],
  }
};
