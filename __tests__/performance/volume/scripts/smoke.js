...
export const options = {
  ...
  thresholds: {
    "http_req_duration{endpoint:all-orders}": ["p(95)<600"],
    ...
    "http_req_duration{endpoint:products-paged}": ["p(95)<200"],
    "http_req_duration{endpoint:product-detail}": ["p(95)<400"],
    "http_req_duration{endpoint:product-photo}": ["p(95)<400"],
    "http_req_duration{endpoint:categories}": ["p(95)<200"],
