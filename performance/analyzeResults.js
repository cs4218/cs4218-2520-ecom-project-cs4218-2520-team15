...
function getK6ResultsPath(stage) {
  const resultsDir = path.join(PROJECT_ROOT, "performance", "results");
...
Write a professional, data-driven analysis that would be useful for developers and DevOps engineers.`;
}
...
function writeReport(analysis, stage = "all") {
  ...
  const reportDir = path.join(PROJECT_ROOT, "performance", "report");  
